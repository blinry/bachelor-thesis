...
\usepackage{slantsc} % enable italic small caps
\usepackage[scaled]{beramono} % default bold typewriter fontface isn't bold enough
\usepackage[ngerman,english]{babel} % hyphenation, captions. german for second abstract version
\usepackage[style=numeric]{biblatex} % bibliography, cite with "[number]"
    \addbibresource{bibliography.bib}
\usepackage{xcolor} % define your own colors, yo!
    \definecolor{medium-blue}{rgb}{0,0,0.5}
\usepackage{multicol} % multiple-column environment
\usepackage{graphicx} % include graphics
\usepackage{enumitem} % for denser lists
\usepackage{pgfplots, pgfplotstable} % draw pretty plots
    ...
    \pgfplotsset{
        ...
        % styles for comparative box plot:
        rshift/.style={
...
\usetikzlibrary{patterns,arrows,fit} % subpackages for drawing package "TikZ"
    \makeatletter
...
\usepackage{soul} % change text foreground and background color
    \sethlcolor{darkgray}
    \newcommand{\invert}[1]{\textcolor{white}{\hl{#1}}}
    \newcommand{\cursor}{\invert{ }}
    \newcommand{\escape}[1]{\textasciicircum #1}
\usepackage{hyperref} % automatically link stuff in PDFs
    \hypersetup{ % to hide links, use option 'hidelinks' instead, duh!
        colorlinks, linkcolor={medium-blue},
        citecolor={medium-blue}, urlcolor={medium-blue}
    }
\usepackage[nameinlink]{cleveref} % \cref creates reference with type, like "section 3.1.4"
\usepackage[os=win]{menukeys} % pretty key combinations
    \renewmenumacro{\keys}[+]{shadowedroundedkeys}
\usepackage{microtype} % typographic perfection
    \DisableLigatures[<,>]{family=tt*}
\usepackage{geometry} % change page borders (for centered titlepage)
...
\subject{\normalfont Bachelor Thesis: The Director's Cut}
...
\begin{figure}[tb]
    \begin{tikzpicture}[trim axis left, trim axis right]
        ...
        \begin{axis}[
            ...
            \addplot [fill=gray, bar shift=-.2cm] table [y=Slot1, x expr=\coordindex] {\datatable};
